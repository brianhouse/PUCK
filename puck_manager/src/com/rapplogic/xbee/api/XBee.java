...
public class XBee implements IXBee {
	...
	public void open(String port, int baudRate) throws XBeeException {
		try {
			if (this.isConnected()) {
				System.out.println("Cannot open new connection -- existing connection is still open.  Please close first");
	 ...
	 * 
	 * @ deprecated Use this.sendSynchronous(command, timeout);		// bh getting rid of deprecation
	 * @param command
	 * @return
	 * @throws XBeeException
	 */
